      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-base sm:text-lg md:text-xl max-w-3xl mx-auto text-[#1F6632]/80">
            Our expert team provides tailored consultation services to help you
            implement the perfect weight scale integration solution for your
            business.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          ...
          <div className="flex flex-col bg-[#FFFEFB] rounded-2xl shadow-lg overflow-hidden">
            <div
              ...
              <p className="text-sm mt-1 text-[#FEFAEA]">
            ...
            <div className="p-6 flex flex-col flex-grow">
              <ul className="space-y-3 flex-grow">
                ...
                {["Custom integration design", "On-site implementation"].map(
                  (item) => (
          ...
          <div className="flex flex-col bg-[#FFFEFB] rounded-2xl shadow-xl overflow-hidden transform scale-100 md:scale-105 border-2 border-[#1F6632]">
            <div
              ...
              <h3 className="text-2xl font-bold text-[#FEFAEA]">
                Professional Package
              </h3>
            ...
            <form className="space-y-6">
              {[
                ...
                <div key={field.id}>
                  <label
                    htmlFor={field.id}
                    className="block mb-2 text-[#1F6632]">
                    {field.label}
                  </label>
                  <input
                    type={field.type}
