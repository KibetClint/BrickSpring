      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto mb-12 text-center">
          <p className="text-base sm:text-lg leading-relaxed text-[#1F6632]/80">
            Many businesses rely on weight scales and computer systems that
            operate in isolation, leading to inaccurate data, wasted resources,
            and slow decision-making. Brickspring Enterprises addresses these
            challenges head-on by integrating weight-scale data with computing
            systems to ensure real-time accuracy and streamlined operations.
          </p>
        </div>
